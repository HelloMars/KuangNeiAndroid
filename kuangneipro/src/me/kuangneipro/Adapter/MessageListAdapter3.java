...
public class MessageListAdapter3 extends ArrayAdapter<MessageEntity> {
	private static final String TAG = MessageListAdapter3.class.getSimpleName(); // tag 用于测试log用  
	...
	public MessageListAdapter3(Activity context, List<MessageEntity> messages) {
